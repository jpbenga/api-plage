...
import fr.hb.jpb.plages.utils.NbInscrits;
...
public interface ClientDao extends JpaRepository<Client, Long> {
    ...
    @Query(value = """
			SELECT new fr.hb.jpb.plages.utils.NbInscrits(year(c.dateHeureInscription), month(c.dateHeureInscription), COUNT(c.id))
			FROM Client c
